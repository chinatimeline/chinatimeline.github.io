...
本站用于提交表单的应用程序接口API已经从[staticman](https://staticman.net)变更为部署在[Vercel](https://chinatimeline-form.vercel.app)的[开源API](https://github.com/chinatimeline/chinatimeline-form)，公众可审计已部署的API不会记录用户IP等信息。
